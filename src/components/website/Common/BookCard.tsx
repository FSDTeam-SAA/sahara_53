  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer pt-0">
      ...
      <div className="relative w-full aspect-video bg-muted overflow-hidden">
        <Image
          src={item.generatedStory[0].chapterImage || "/images/no-image.jpg"}
          width={500}
          height={500}
          alt={item.title}
      ...
      <div className="px-4 pt-1 flex items-center gap-2 flex-wrap">
        <span className="inline-flex items-center gap-1 px-2 py-1 rounded-sm bg-[#E7E7FD] text-[#5D5FEF] text-xs font-medium">
          {item.genre}
        </span>
